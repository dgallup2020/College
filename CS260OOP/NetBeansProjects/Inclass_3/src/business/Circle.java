...
public class Circle
{
    ...
    //use setters to ensure that there will always be a
    //valid value stored in the class attribute variable
    ...
    //only allow access to class attribute variables through getters
    //even from within the class
