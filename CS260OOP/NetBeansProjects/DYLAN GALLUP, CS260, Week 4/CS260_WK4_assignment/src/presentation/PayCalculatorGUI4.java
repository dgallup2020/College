 ...
 * @author Dylan Gallup
 */
public class PayCalculatorGUI4 extends javax.swing.JFrame {
    
    private Employee4 enterEmployee;
    
    /**
     * Creates new form PayCalculatorGUI
     */
    public PayCalculatorGUI4() {
        initComponents();
    ...
    private void calculateData(){
        ...
        if (!StringHelpers.IsNullOrEmpty(str)) {
            fnamecheck = true;
            enterEmployee.getPerson().setFirstName(str);
        }
        ...
        if (!StringHelpers.IsNullOrEmpty(str2)) {
            lnamecheck = true;
            enterEmployee.getPerson().setLastName(str2);
        }
        ...
        if (valid) {
            double hoursWorked1 = InputHelpers.parseDoubleField(txtHours, "HOURS WORKED", enterEmployee.getPay().MIN_HOURS, enterEmployee.getPay().MAX_HOURS);
            if (hoursWorked1 != (double)InputHelpers.CANCEL_FLAG) {
                enterEmployee.getPay().setHoursWorked(hoursWorked1);
            }
            else {
                valid = false;
            }
        ...
        if (valid) {
            double payrate1 = InputHelpers.parseDoubleField(txtPayRate, "PAY RATE", enterEmployee.getPay().MIN_RATE, enterEmployee.getPay().MAX_RATE);
            if (payrate1 != InputHelpers.CANCEL_FLAG) {
                enterEmployee.getPay().setPayRate(payrate1);
            }
            else {
                valid = false;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayCalculatorGUI4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new PayCalculatorGUI4().setVisible(true);
            }
        });
    }
