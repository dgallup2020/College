...
public class Main_Shapes extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_Shapes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        Main_Shapes mainForm = new Main_Shapes();
