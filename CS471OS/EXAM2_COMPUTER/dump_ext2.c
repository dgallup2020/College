// See http://www.nongnu.org/ext2-doc/ext2.html for documentation on ext2
// See buildImage.sh for how the file system image we are testing was built
...
/*
  ...
  Bytes                              Contents
  ----------------------------------------
  0-1023                             boot loader, boot record (not part of the FS
  1024-2047                          super block
  2048                               first block group
  2048+s_blocks_per_group*blocksize  second blockgroup
 */
