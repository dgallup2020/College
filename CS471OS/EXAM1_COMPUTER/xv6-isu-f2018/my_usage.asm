...
_my_usage:     file format elf32-i386
...
printf(int fd, char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb a7 07 00 00       	mov    $0x7a7,%ebx
        while(*s != 0){
 ...
 606:	73 10                	jae    618 <free+0x38>
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 639:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6c9:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
 ...
 6f2:	e8 e9 fe ff ff       	call   5e0 <free>
  return freep;
 6f7:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 724:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 727:	89 15 58 0a 00 00    	mov    %edx,0xa58
}
 ...
 73f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 58 0a 00 00 5c 	movl   $0xa5c,0xa58
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf 5c 0a 00 00       	mov    $0xa5c,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 762:	00 00 00 
    if(p->s.size >= nunits){
