...
_timing:     file format elf32-i386
  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  if(argc < 2){
  1a:	0f 8e d1 00 00 00    	jle    f1 <main+0xf1>
  ...
  73:	83 c6 01             	add    $0x1,%esi
    int f = open("nothing.txt", O_WRONLY | O_CREATE);
  76:	68 01 02 00 00       	push   $0x201
  7b:	68 44 09 00 00       	push   $0x944
  80:	e8 2c 03 00 00       	call   3b1 <open>
    write(f, "hello", 5);
  ...
  8a:	89 c7                	mov    %eax,%edi
    write(f, "hello", 5);
  8c:	68 50 09 00 00       	push   $0x950
  91:	50                   	push   %eax
  92:	e8 fa 02 00 00       	call   391 <write>
    close(f);
  97:	89 3c 24             	mov    %edi,(%esp)
  9a:	e8 fa 02 00 00       	call   399 <close>
    z++;
  9f:	83 c4 10             	add    $0x10,%esp
  while (uptime() - middle_ticks < numTicks) {
  a2:	e8 62 03 00 00       	call   409 <uptime>
  a7:	2b 45 c4             	sub    -0x3c(%ebp),%eax
  aa:	39 c3                	cmp    %eax,%ebx
  ac:	77 c2                	ja     70 <main+0x70>
  }
  printf(1,"%d disk operations\n", z);
  ae:	50                   	push   %eax
  af:	56                   	push   %esi
  b0:	68 56 09 00 00       	push   $0x956
  b5:	6a 01                	push   $0x1
  b7:	e8 34 04 00 00       	call   4f0 <printf>

  struct trap_counts t;
  ticks(&t);
  bc:	8d 45 cc             	lea    -0x34(%ebp),%eax
  bf:	89 04 24             	mov    %eax,(%esp)
  c2:	e8 52 03 00 00       	call   419 <ticks>
  printf(1, "Trap/interrupt counts... %d syscall, %d timer, %d kbd, %d com1, %d ide, %d error, %d spurious\n",
  c7:	5a                   	pop    %edx
  c8:	ff 75 e4             	pushl  -0x1c(%ebp)
  cb:	ff 75 e0             	pushl  -0x20(%ebp)
  ce:	ff 75 dc             	pushl  -0x24(%ebp)
  d1:	ff 75 d8             	pushl  -0x28(%ebp)
  d4:	ff 75 d4             	pushl  -0x2c(%ebp)
  d7:	ff 75 d0             	pushl  -0x30(%ebp)
  da:	ff 75 cc             	pushl  -0x34(%ebp)
  dd:	68 b4 08 00 00       	push   $0x8b4
  e2:	6a 01                	push   $0x1
  e4:	e8 07 04 00 00       	call   4f0 <printf>
         t.syscall, t.timer, t.kbd, t.com1, t.ide, t.error, t.spurious);
  
  exit();
  e9:	83 c4 30             	add    $0x30,%esp
 ...
 108:	e8 e3 03 00 00       	call   4f0 <printf>
    exit();
 10d:	e8 5f 02 00 00       	call   371 <exit>
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 6a 09 00 00       	mov    $0x96a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 28 0c 00 00       	mov    %eax,0xc28
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 28 0c 00 00       	mov    %eax,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	8b 15 28 0c 00 00    	mov    0xc28,%edx
 ...
 804:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 807:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
