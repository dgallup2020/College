...
_memory:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  2d:	68 2d 08 00 00       	push   $0x82d
  32:	6a 01                	push   $0x1
  34:	e8 77 04 00 00       	call   4b0 <printf>
  printf(1, "data, &globalVar: %p\n", &globalVar);
  39:	83 c4 0c             	add    $0xc,%esp
  3c:	68 88 0b 00 00       	push   $0xb88
  41:	68 43 08 00 00       	push   $0x843
  46:	6a 01                	push   $0x1
  ...
  50:	53                   	push   %ebx
  51:	68 59 08 00 00       	push   $0x859
  56:	6a 01                	push   $0x1
  58:	e8 53 04 00 00       	call   4b0 <printf>
  char *s = (char *) malloc(10 * sizeof(char)); // should be on "the heap"
  5d:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  64:	e8 a7 06 00 00       	call   710 <malloc>
  strcpy(s,"abcdefg");
  69:	5a                   	pop    %edx
  6a:	59                   	pop    %ecx
  6b:	68 6f 08 00 00       	push   $0x86f
  70:	50                   	push   %eax
  char *s = (char *) malloc(10 * sizeof(char)); // should be on "the heap"
  71:	89 c6                	mov    %eax,%esi
  strcpy(s,"abcdefg");
  73:	e8 68 00 00 00       	call   e0 <strcpy>
  printf(1, "heap, s:          %p\n", s);
  78:	83 c4 0c             	add    $0xc,%esp
  7b:	56                   	push   %esi
  7c:	68 77 08 00 00       	push   $0x877
  81:	6a 01                	push   $0x1
  83:	e8 28 04 00 00       	call   4b0 <printf>

  if (argc > 1) {
  88:	83 c4 10             	add    $0x10,%esp
  8b:	83 3b 01             	cmpl   $0x1,(%ebx)
  8e:	7e 1f                	jle    af <main+0xaf>
    char *p = (char *) atoi(argv[1]);
  90:	83 ec 0c             	sub    $0xc,%esp
  93:	ff 77 04             	pushl  0x4(%edi)
  96:	e8 25 02 00 00       	call   2c0 <atoi>
    printf(1, "&%p = %x\n", p, *p);
  9b:	0f be 10             	movsbl (%eax),%edx
  9e:	52                   	push   %edx
  9f:	50                   	push   %eax
  a0:	68 8d 08 00 00       	push   $0x88d
  a5:	6a 01                	push   $0x1
  ...
  cb:	68 40 42 0f 00       	push   $0xf4240
  d0:	e8 ec 02 00 00       	call   3c1 <sleep>
  d5:	83 c4 10             	add    $0x10,%esp
  d8:	eb ee                	jmp    c8 <main+0xc8>
  da:	66 90                	xchg   %ax,%ax
  dc:	66 90                	xchg   %ax,%ax
  de:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb c8 08 00 00       	mov    $0x8c8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	8b 15 8c 0b 00 00    	mov    0xb8c,%edx
 ...
 7c4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 8c 0b 00 00    	mov    %edx,0xb8c
}
 ...
 7df:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 8c 0b 00 00 90 	movl   $0xb90,0xb8c
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 90 0b 00 00       	mov    $0xb90,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 802:	00 00 00 
    if(p->s.size >= nunits){
