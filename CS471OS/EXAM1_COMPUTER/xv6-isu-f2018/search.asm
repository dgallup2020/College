...
main(int argc, char *argv[])
{
  ...
  12:	83 ec 70             	sub    $0x70,%esp
  if(argc < 2){
  15:	83 39 01             	cmpl   $0x1,(%ecx)
  18:	7e 29                	jle    43 <main+0x43>
  ...
  23:	68 e7 03 00 00       	push   $0x3e7
  28:	53                   	push   %ebx
  29:	e8 42 01 00 00       	call   170 <gets>
  printf(1,"r: %s\n",s2);
  2e:	83 c4 0c             	add    $0xc,%esp
  31:	50                   	push   %eax
  32:	68 a7 07 00 00       	push   $0x7a7
  37:	6a 01                	push   $0x1
  39:	e8 f2 03 00 00       	call   430 <printf>
  3e:	83 c4 10             	add    $0x10,%esp
  41:	eb dd                	jmp    20 <main+0x20>
  ...
  4c:	e8 df 03 00 00       	call   430 <printf>
    exit();
  51:	e8 5b 02 00 00       	call   2b1 <exit>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
