  ...
  14:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  23:	6a 01                	push   $0x1
  25:	e8 c6 04 00 00       	call   4f0 <printf>
    exit();
  2a:	e8 42 03 00 00       	call   371 <exit>
  }
  ...
  char *filename = argv[1];
  32:	8b 70 04             	mov    0x4(%eax),%esi
  int inc = atoi(argv[2]);
  35:	ff 70 08             	pushl  0x8(%eax)
  int count;
  int f;
  ...
  int inc = atoi(argv[2]);
  3a:	e8 c1 02 00 00       	call   300 <atoi>
  for(i=0; i < inc; i++) {
  3f:	83 c4 10             	add    $0x10,%esp
  int inc = atoi(argv[2]);
  42:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  for(i=0; i < inc; i++) {
  45:	85 c0                	test   %eax,%eax
  47:	7f 7f                	jg     c8 <main+0xc8>
    }
  ...
  49:	51                   	push   %ecx
  4a:	ff 75 e4             	pushl  -0x1c(%ebp)
  4d:	68 75 08 00 00       	push   $0x875
  52:	6a 01                	push   $0x1
  54:	e8 97 04 00 00       	call   4f0 <printf>
  
  exit();
  59:	e8 13 03 00 00       	call   371 <exit>
  5e:	66 90                	xchg   %ax,%ax
  ...
  68:	50                   	push   %eax
  69:	57                   	push   %edi
  6a:	e8 1a 03 00 00       	call   389 <read>
      if (status < 0) {
  6f:	83 c4 10             	add    $0x10,%esp
  72:	85 c0                	test   %eax,%eax
  74:	0f 88 8f 00 00 00    	js     109 <main+0x109>
      close(f);
  7a:	83 ec 0c             	sub    $0xc,%esp
  7d:	57                   	push   %edi
  7e:	e8 16 03 00 00       	call   399 <close>
  ...
  8f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    f = open(filename, O_WRONLY | O_CREATE);
  92:	68 01 02 00 00       	push   $0x201
  97:	56                   	push   %esi
  98:	e8 14 03 00 00       	call   3b1 <open>
    if (f < 0) {
  ...
  a4:	78 50                	js     f6 <main+0xf6>
    write(f, &count, sizeof(count));
  a6:	83 ec 04             	sub    $0x4,%esp
  a9:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  for(i=0; i < inc; i++) {
  ...
  b1:	50                   	push   %eax
  b2:	57                   	push   %edi
  b3:	e8 d9 02 00 00       	call   391 <write>
    close(f);
  b8:	89 3c 24             	mov    %edi,(%esp)
  bb:	e8 d9 02 00 00       	call   399 <close>
  for(i=0; i < inc; i++) {
  c0:	83 c4 10             	add    $0x10,%esp
  c3:	39 5d d4             	cmp    %ebx,-0x2c(%ebp)
  c6:	74 81                	je     49 <main+0x49>
    f = open(filename, O_RDONLY);
  c8:	83 ec 08             	sub    $0x8,%esp
  cb:	6a 00                	push   $0x0
  cd:	56                   	push   %esi
  ce:	e8 de 02 00 00       	call   3b1 <open>
  ...
  da:	79 84                	jns    60 <main+0x60>
      printf(1, "File %s does not exist, will initialize to 0.\n", filename);
  dc:	83 ec 04             	sub    $0x4,%esp
  df:	56                   	push   %esi
  e0:	68 c4 08 00 00       	push   $0x8c4
  e5:	6a 01                	push   $0x1
  e7:	e8 04 04 00 00       	call   4f0 <printf>
      count = 0;
  ec:	83 c4 10             	add    $0x10,%esp
  ef:	b8 01 00 00 00       	mov    $0x1,%eax
  f4:	eb 96                	jmp    8c <main+0x8c>
      printf(1, "Unable to open/create file.\n");
  f6:	50                   	push   %eax
  f7:	50                   	push   %eax
  f8:	68 a5 08 00 00       	push   $0x8a5
  fd:	6a 01                	push   $0x1
  ff:	e8 ec 03 00 00       	call   4f0 <printf>
      exit();
 104:	e8 68 02 00 00       	call   371 <exit>
        printf(1, "Unable to read file.\n");
 109:	52                   	push   %edx
 10a:	52                   	push   %edx
 10b:	68 8f 08 00 00       	push   $0x88f
 110:	6a 01                	push   $0x1
 112:	e8 d9 03 00 00       	call   4f0 <printf>
        exit();
 117:	e8 55 02 00 00       	call   371 <exit>
 ...
 436:	89 d3                	mov    %edx,%ebx
{
 ...
 479:	0f b6 92 fc 08 00 00 	movzbl 0x8fc(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb f4 08 00 00       	mov    $0x8f4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 b0 0b 00 00       	mov    0xbb0,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 b0 0b 00 00       	mov    %eax,0xbb0
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 b0 0b 00 00       	mov    %eax,0xbb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d b0 0b 00 00    	mov    0xbb0,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
 ...
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf b4 0b 00 00       	mov    $0xbb4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 842:	00 00 00 
    if(p->s.size >= nunits){
