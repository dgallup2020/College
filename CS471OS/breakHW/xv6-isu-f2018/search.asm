  ...
  17:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  23:	6a 64                	push   $0x64
  25:	56                   	push   %esi
  26:	e8 65 01 00 00       	call   190 <gets>
  2b:	89 c3                	mov    %eax,%ebx
    if(s2[strlen(s2)-1] == '\n')
  2d:	89 04 24             	mov    %eax,(%esp)
  30:	e8 cb 00 00 00       	call   100 <strlen>
  35:	83 c4 10             	add    $0x10,%esp
  38:	80 7c 03 ff 0a       	cmpb   $0xa,-0x1(%ebx,%eax,1)
  3d:	75 11                	jne    50 <main+0x50>
    	s2[strlen(s2)-1] = '\0';
  3f:	83 ec 0c             	sub    $0xc,%esp
  42:	53                   	push   %ebx
  43:	e8 b8 00 00 00       	call   100 <strlen>
  48:	83 c4 10             	add    $0x10,%esp
  4b:	c6 44 03 ff 00       	movb   $0x0,-0x1(%ebx,%eax,1)
    if(0==strcmp(s2,argv[1]))
  50:	83 ec 08             	sub    $0x8,%esp
  53:	ff 77 04             	pushl  0x4(%edi)
  56:	53                   	push   %ebx
  57:	e8 54 00 00 00       	call   b0 <strcmp>
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	eb bf                	jmp    20 <main+0x20>
  ...
  6a:	e8 e1 03 00 00       	call   450 <printf>
    exit();
  6f:	e8 5d 02 00 00       	call   2d1 <exit>
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb c7 07 00 00       	mov    $0x7c7,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	8b 15 88 0a 00 00    	mov    0xa88,%edx
